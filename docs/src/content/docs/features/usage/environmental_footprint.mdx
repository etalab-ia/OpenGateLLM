...
<Tabs>
  ...
  Environmental footprint is only supported for `text-generation` model types. For other model types, the environmental impact will not be computed (display as 0 kWh and 0 kgCO2eq).
  </Aside>
