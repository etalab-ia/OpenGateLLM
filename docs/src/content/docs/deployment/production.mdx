...
- Usage is logged to PostgreSQL. Consider a data retention policy for the usage table to manage database size. 
...
- For error monitoring, configure the optional `dependencies.sentry` section. 
