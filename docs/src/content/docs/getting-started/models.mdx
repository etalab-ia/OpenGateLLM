...
<Tabs>
  ...
  <TabItem value="config" label="API" icon="seti:html">
  <Steps>
    <ol>
      <li>
        Create a router.
        See <code>/v1/admin/routers</code> endpoint in <a href="/reference/">API Reference</a> for more details.
      </li>
      <li>
        Create a provider.
        See <code>/v1/admin/providers</code> endpoint in <a href="/reference/">API Reference</a> for more details.
      </li>
      <li>
        Verify configuration.
        See <code>/v1/models</code> endpoint in <a href="/reference/">API Reference</a> for more details.
        See <code>/v1/models/my-chat-model</code> endpoint in <a href="/reference/">API Reference</a> for more details.
      </li>
    </ol>
  </Steps>
  </TabItem>
