...
ROUTER__ADMIN_ORGANIZATIONS = "admin.organizations"
ROUTER__ADMIN_ROLES = "admin.roles"
ROUTER__ADMIN_TOKENS = "admin.tokens"
ROUTER__ADMIN_USERS = "admin.users"
