...
class ModelsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        See
        https://platform.openai.com/docs/api-reference/models/list for the API
        specification.
        ...
        return cast(
            ...
            self._get(
                ...
                options=make_request_options(
                    ...
                    timeout=timeout,
                    query=maybe_transform({"model": model}, model_list_params.ModelListParams),
                ),
        ...
        return cast(
            ...
            await self._get(
                ...
                options=make_request_options(
                    ...
                    extra_body=extra_body,
                    timeout=timeout,
                    query=await async_maybe_transform({"model": model}, model_list_params.ModelListParams),
                ),
                cast_to=cast(Any, ModelListResponse),  # Union types cannot be passed in as arguments in the type system
            ),
        )
