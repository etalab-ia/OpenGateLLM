...
class TestRoles:
    ...
    def test_method_create(self, client: Opengatellm) -> None:
        role = client.admin.roles.create(
            name="x",
        )
    ...
    def test_raw_response_create(self, client: Opengatellm) -> None:
        response = client.admin.roles.with_raw_response.create(
            name="x",
        )
    ...
    def test_streaming_response_create(self, client: Opengatellm) -> None:
        with client.admin.roles.with_streaming_response.create(
            name="x",
        ) as response:
    ...
    def test_method_update(self, client: Opengatellm) -> None:
        role = client.admin.roles.update(
            role=0,
        )
        assert role is None
    ...
    def test_raw_response_update(self, client: Opengatellm) -> None:
        response = client.admin.roles.with_raw_response.update(
            role=0,
        )
    ...
    def test_streaming_response_update(self, client: Opengatellm) -> None:
        with client.admin.roles.with_streaming_response.update(
            role=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Opengatellm) -> None:
        role = client.admin.roles.delete(
            0,
        )
        assert role is None
    ...
    def test_raw_response_delete(self, client: Opengatellm) -> None:
        response = client.admin.roles.with_raw_response.delete(
            0,
        )
    ...
    def test_streaming_response_delete(self, client: Opengatellm) -> None:
        with client.admin.roles.with_streaming_response.delete(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncRoles:
    ...
    async def test_method_create(self, async_client: AsyncOpengatellm) -> None:
        role = await async_client.admin.roles.create(
            name="x",
        )
        assert_matches_type(RoleCreateResponse, role, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncOpengatellm) -> None:
        response = await async_client.admin.roles.with_raw_response.create(
            name="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncOpengatellm) -> None:
        async with async_client.admin.roles.with_streaming_response.create(
            name="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update(self, async_client: AsyncOpengatellm) -> None:
        role = await async_client.admin.roles.update(
            role=0,
        )
        assert role is None
    ...
    async def test_raw_response_update(self, async_client: AsyncOpengatellm) -> None:
        response = await async_client.admin.roles.with_raw_response.update(
            role=0,
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncOpengatellm) -> None:
        async with async_client.admin.roles.with_streaming_response.update(
            role=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncOpengatellm) -> None:
        role = await async_client.admin.roles.delete(
            0,
        )
        assert role is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncOpengatellm) -> None:
        response = await async_client.admin.roles.with_raw_response.delete(
            0,
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncOpengatellm) -> None:
        async with async_client.admin.roles.with_streaming_response.delete(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
