...
Revision ID: 208e1420dc3d
Revises: a1b2c3d4e5f6
Create Date: 2025-10-27 16:36:33.082040
...
def upgrade() -> None:
    ...
    sa.Column('qos_policy', sa.String(), nullable=False),
    ...
    op.drop_index('ix_model_client_id', table_name='model_client')
    op.drop_table('model_client')


    op.drop_index('ix_model_alias_id', table_name='model_alias')
    ...
    op.drop_index('ix_limit_id', table_name='limit')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('usage_user_id_fkey', 'usage', 'user', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    op.drop_constraint('unique_rate_limit_per_role', 'limit', type_='unique')
    op.create_unique_constraint('unique_rate_limit_per_role', 'limit', ['role_id', 'model', 'type'], postgresql_nulls_not_distinct=False)
    op.create_index('ix_limit_id', 'limit', ['id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['model_router_name'], ['model.name'], name='model_alias_model_router_name_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='model_alias_pkey')
    )
    op.create_index('ix_model_alias_id', 'model_alias', ['id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['model_router_name'], ['model.name'], name='model_client_model_router_name_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='model_client_pkey')
    )
    op.create_index('ix_model_client_id', 'model_client', ['id'], unique=False)
