...
class CreateRouterBody(BaseModel):
    ...
    router_type: ModelType = Field(..., description="Type of the model router. It will be used to identify the model router type.", examples=["text-generation"], alias=["type"])  # fmt: off
...
class UpdateRouterBody(BaseModel):
    ...
    router_type: ModelType | None = Field(default=None, description="Type of the model router. It will be used to identify the model router type.", examples=["text-generation"], alias=["type"])  # fmt: off
