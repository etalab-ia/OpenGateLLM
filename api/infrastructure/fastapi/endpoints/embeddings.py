...
from api.dependencies import create_embeddings_use_case_factory, get_authenticated_user
...
async def create_embeddings(
    ...
    try:
        command = CreateEmbeddingsCommand(**body.model_dump(), authenticated_user=authenticated_user)
