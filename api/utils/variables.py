...
PREFIX__REDIS_QOS_LOAD: str = "ogl_qos:load"
METRICS__TIMESERIE_RETENTION_SECONDS: int = 60 * 30  # 30 minutes

QOS_WAIT_SLEEP_SECONDS: float = 0.5
QOS_HEARTBEAT_INTERVAL_SECONDS: float = 10.0
QOS_HEARTBEAT_TTL_MS: int = 30_000
QOS_HEARTBEAT_REDIS_RETRIES: int = 3
CLIENT_DISCONNECT_POLL_SECONDS: float = 0.5
