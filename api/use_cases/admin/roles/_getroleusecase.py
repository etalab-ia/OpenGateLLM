...
type GetRoleUseCaseResult = GetRoleUseCaseSuccess | RoleNotFoundError | UserExpiredError | UserIsNotAdminError


class GetRoleUseCase:
    def __init__(self, role_repository: RoleRepository, user_with_role_query: UserWithRoleQuery):
