...
class TestModelForwardReleasesConnection:
    def _build_app(self, probe_engine, autocommit_session_factory, test_configuration, test_redis_pool):
    ...
    async def test_autocommit_wiring_releases_the_connection_during_the_forward(
        self, scenario, probe_engine, seed_forward_auth, test_configuration, test_redis_pool
    ):
        app = self._build_app(
            probe_engine,
