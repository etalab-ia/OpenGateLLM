...
class TestCreateKey:
    ...
    async def setup(self, db_session):
        ...
        self.target_user = UserSQLFactory()
    ...
    async def test_happy_path(self, client: AsyncClient):
        response = await client.post(
            ...
            json=_valid_body(user_id=self.target_user.id),
        )
    ...
    async def test_error_maps_to_correct_http_status(self, client: AsyncClient, app, use_case_result, expected_status, expected_detail):
        ...
        app.dependency_overrides[create_key_use_case_factory] = lambda: mock_use_case
    ...
    async def test_auth(self, client: AsyncClient, headers, expected_status, expected_detail):
        response = await client.post(url=URL, headers=headers, json=_valid_body(user_id=self.target_user.id))
