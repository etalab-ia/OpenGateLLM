...
class TestCreateProvider:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ProviderInvalidResponseError(model_name="my-model", detail="no embedding returned"),
                424,
                "Model provider my-model returned an invalid response: no embedding returned",
            ),
            (
