...
def setup_mistral_image_to_text_model_and_user(client: TestClient):
    test_id = generate_test_id(prefix="TestMistralImageToText")
...
class TestMistralImageToText:
    def test_mistral_ocr_successful(self, client: TestClient, setup_mistral_image_to_text_model_and_user):
