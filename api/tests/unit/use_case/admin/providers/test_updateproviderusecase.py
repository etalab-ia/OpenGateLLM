...
class TestUpdateProviderUseCase:
    ...
    async def test_should_return_user_is_not_admin_error_when_user_is_not_admin(
        self, use_case, provider_repository, router_repository, user_with_role_query, unauthorized_user_info, default_command
    ):
        # Arrange
    ...
    async def test_should_return_provider_not_found_error_when_provider_does_not_exist(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info, default_command
    ):
        # Arrange
    ...
    async def test_should_return_router_not_found_error_when_current_router_does_not_exist(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info, sample_provider, default_command
    ):
        # Arrange
        user_with_role_query.get_user_with_role_by_id.return_value = admin_user_info
    ...
    async def test_should_return_router_not_found_error_when_new_router_does_not_exist(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info, sample_provider, sample_router
    ):
        # Arrange
        user_with_role_query.get_user_with_role_by_id.return_value = admin_user_info
        provider_repository.get_one_provider.return_value = sample_provider
    ...
    async def test_should_return_invalid_provider_type_error_when_type_not_compatible_with_new_router(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info, sample_provider
    ):
        # Arrange
        user_with_role_query.get_user_with_role_by_id.return_value = admin_user_info
    ...
    async def test_should_return_inconsistent_vector_size_error_when_new_router_has_different_vector_size(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info
    ):
        # Arrange
        user_with_role_query.get_user_with_role_by_id.return_value = admin_user_info
    ...
    async def test_should_not_call_update_provider_when_no_fields_are_changed(
        self, use_case, provider_repository, router_repository, user_with_role_query, admin_user_info, sample_provider, sample_router, default_command
    ):
        # Arrange
        user_with_role_query.get_user_with_role_by_id.return_value = admin_user_info
        provider_repository.get_one_provider.return_value = sample_provider
