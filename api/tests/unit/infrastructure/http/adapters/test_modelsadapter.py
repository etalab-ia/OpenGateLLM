...
class TestModelsAdapter:
    ...
    def test_to_provider_response_correctly_when_provider_is_albert(self, albert_models_adapter: AlbertModelsAdapter):
        # Arrange
        ...
        # Act
        result = albert_models_adapter.to_provider_response(http_response=original_response, request=original_request)
    ...
    def test_to_provider_response_correctly_when_provider_is_openai(self, openai_models_adapter: OpenaiModelsAdapter):
        # Arrange
        ...
        # Act
        result = openai_models_adapter.to_provider_response(http_response=original_response, request=original_request)
    ...
    def test_to_provider_response_correctly_when_provider_is_mistral(self, mistral_models_adapter: MistralModelsAdapter):
        # Arrange
        ...
        # Act
        result = mistral_models_adapter.to_provider_response(http_response=original_response, request=original_request)
    ...
    def test_to_provider_response_correctly_when_provider_is_tei(self, tei_models_adapter: TeiModelsAdapter):
        # Arrange
        ...
        # Act
        result = tei_models_adapter.to_provider_response(http_response=original_response, request=original_request)
    ...
    def test_to_provider_response_correctly_when_provider_is_vllm(self, vllm_models_adapter: VllmModelsAdapter):
        # Arrange
        ...
        # Act
        result = vllm_models_adapter.to_provider_response(http_response=original_response, request=original_request)
