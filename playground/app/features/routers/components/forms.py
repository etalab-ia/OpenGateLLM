...
def router_edit_form_fields() -> rx.Component:
    ...
    return rx.grid(
        entity_form_input_field(
            label="Name",
            value=RoutersState.router_name,
            on_change=RoutersState.set_router_name,
        ...
        entity_form_select_field(
            ...
            value=RoutersState.router_type,
            on_change=RoutersState.set_router_type,
            tooltip="Router type (e.g., text-generation)",
            disable=RoutersState.edit_entity_loading,
        ),
        entity_form_input_field(
            label="Aliases",
            value=RoutersState.router_aliases,
            on_change=RoutersState.set_router_aliases,
            type="list",
            disable=RoutersState.edit_entity_loading,
        ),
        entity_form_select_field(
            ...
            value=RoutersState.router_load_balancing_strategy,
            on_change=RoutersState.set_router_load_balancing_strategy,
            tooltip="Strategy to use for load balancing between providers of the router",
            disable=RoutersState.edit_entity_loading,
        ),
        entity_form_input_field(
            label="Prompt tokens cost",
            value=RoutersState.router_cost_prompt_tokens,
            on_change=RoutersState.set_router_cost_prompt_tokens,
        ...
        entity_form_input_field(
            ...
            value=RoutersState.router_cost_completion_tokens,
            on_change=RoutersState.set_router_cost_completion_tokens,
