...
from app.shared.components.forms import entity_create_form, entity_create_form_input_field, entity_create_form_select_field


def provider_create_form_fields() -> rx.Component:
    """Fields of the provider create form."""
    return rx.grid(
        entity_create_form_select_field(
            label="API type*",
        ...
        entity_create_form_input_field(
            label="Model name*",
