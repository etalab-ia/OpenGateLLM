...
def provider_create_form_fields() -> rx.Component:
    ...
    return rx.grid(
        ...
        entity_form_select_field(
            ...
            value=ProvidersState.new_provider_model_carbon_footprint_zone,
            on_change=ProvidersState.set_new_provider_model_carbon_footprint_zone,
        ...
        entity_form_input_field(
            ...
            value=ProvidersState.new_provider_model_carbon_footprint_total_params,
            on_change=ProvidersState.set_new_provider_model_carbon_footprint_total_params,
        ...
        entity_form_input_field(
            ...
            value=ProvidersState.new_provider_model_carbon_footprint_active_params,
            on_change=ProvidersState.set_new_provider_model_carbon_footprint_active_params,
